    ...
    <div class="content-wrapper">
      <div class="text-content">
        <h2 class="section-title">
          <span class="gradient-text">Наша Команда </span><br>
          в Арбитраже
        </h2>
...
const stats = ref([
  { 
    value: 'Более миллиона', 
    label: 'Оборот денежных средств в месяц ',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
          </svg>`
  },
  { 
    value: 'Активный Чатинг', 
    label: 'Происходит ежедневно в нашем Телеграмм',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
.icon-glow {
  ...
  top: -10%;
  left: -10%;
  background: radial-gradient(rgba(138, 43, 226, 0.3) 0%, transparent 70%);
