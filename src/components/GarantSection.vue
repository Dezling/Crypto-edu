    ...
    <div class="content-wrapper">
      <h2 class="section-title">
        ...
        <span class="animated-underline">
			Профессионализм и результаты</span>
      </h2>
...
const trustReasons = ref([
  {
    title: '7 лет практики',
    text: 'Реальный опыт работы в криптоарбитраже',
  ...
  {
    title: '500+ учеников',
    text: 'Успешно завершивших обучение',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Прозрачность',
    text: 'Открытая статистика и кейсы учеников',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Поддержка',
    text: 'Персональный куратор на всех этапах',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
.trust-card:hover .card-decoration {
  transform: scale(1.2);
}
.trust-section {
  padding: 8rem 0;
...
.trust-card:hover .card-inner::before {
  transform: scale(1.2);
}
...
.card-icon::after {
  ...
  inset: 0;
  border-radius: 50%;
  background: linear-gradient(45deg, #8A2BE2, transparent 70%);
  opacity: 0;
  transition: opacity 0.4s ease;
}

.trust-card:hover .card-icon::after {
  opacity: 0.2;
}
...
.trust-card:hover .card-title::after {
  width: 100%;
}
