...
const benefits = ref([
  {
    ...
    text: 'Вы получите уникальную систему торговли, которая позволит вам работать без карт ',
  ...
  {
    title: 'Безопасность',
    text: 'Вы не нарушаете закон и не ставите свои личные счета под угрозу',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
