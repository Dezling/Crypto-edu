...
const modules = ref([
  {
    ...
    points: [
      ' Практика арбитраж и учёт финансов.',
      'Ставлю ученику "базу", показываю как работать в "стакане" так, чтобы зарабатывать даже без ликвидности на рынке.'
    ],
    ...
    points: [
      ...
      'Темы урока : Как доставать деньги после блокировки, Уникализация устройств. ',
      'Как перевыпустить счёт после блокировки, всё про дропов ( от поиска до организации работы ), компрометация.'
    ],
